...
namespace ScrumBoard.Adapters.Outbound.Persistence.Idempotency;

public enum StoredIdempotencyState
{
    Acquired,
    InProgress,
    Completed
...
public sealed record StoredIdempotencyReservation(
    Guid Id,
    StoredIdempotencyState State,
    string RequestHash,
    StoredIdempotentResponse? Response);
    ...
    IServiceScopeFactory scopeFactory)
{
    ...
    public async Task<StoredIdempotencyReservation> ReserveAsync(
        Guid userId,
        string operation,
        string key,
        string requestHash,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new StoredIdempotencyReservation(
                record.Id,
                StoredIdempotencyState.Acquired,
                requestHash,
                null);
        }
    ...
    private static StoredIdempotencyReservation ToReservation(IdempotencyRecordRow record) => record.IsCompleted
        ? new StoredIdempotencyReservation(
            record.Id,
            StoredIdempotencyState.Completed,
            record.RequestHash,
        ...
        : new StoredIdempotencyReservation(
            record.Id,
            StoredIdempotencyState.InProgress,
            record.RequestHash,
            null);
}
