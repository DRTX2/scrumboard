...
namespace ScrumBoard.Api.Contracts;
...
internal static class ApiResponses
{
    ...
    public static ColumnMutationResponse ToResponse(this ColumnResponse column) => new(
        column.Id, column.ProjectId, column.Name, column.Position, Etag(column.Version), Etag(column.BoardVersion));

    public static TaskMutationResponse ToResponse(this TaskResponse task) => new(
