...
{
    Task<BoardSnapshot> GetAsync(Guid projectId, TaskFilter filter, int taskLimit, CancellationToken cancellationToken);
    Task<TaskPage> GetTasksAsync(
        Guid projectId,
        Guid columnId,
        TaskFilter filter,
        int limit,
    ...
    Task<long> DeleteColumnAsync(Guid projectId, Guid columnId, long expectedVersion, CancellationToken cancellationToken);
    ...
    Task<long> DeleteTaskAsync(Guid projectId, Guid taskId, long expectedVersion, CancellationToken cancellationToken);
