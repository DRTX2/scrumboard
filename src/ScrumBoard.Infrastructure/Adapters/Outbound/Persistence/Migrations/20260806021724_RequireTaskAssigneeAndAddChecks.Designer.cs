...
namespace ScrumBoard.Infrastructure.Adapters.Outbound.Persistence.Migrations
{
    ...
    [Migration("20260806021724_RequireTaskAssigneeAndAddChecks")]
    partial class RequireTaskAssigneeAndAddChecks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScrumBoard.Infrastructure.Adapters.Outbound.Persistence.Models.IdempotencyRecordRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("BoardEtag")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("board_etag");
