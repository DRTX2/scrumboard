...
#nullable disable
#pragma warning disable CA1861 // Generated migration uses inline data arrays.
...
namespace ScrumBoard.Infrastructure.Persistence.Migrations
{
    ...
    public partial class SeedDemoWorkspace : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "tasks",
                columns: new[] { "id", "assignee_id", "column_id", "created_at", "description", "position", "priority", "project_id", "title", "updated_at", "version" },
                values: new object[,]
                {
                    { new Guid("40000000-0000-0000-0000-000000000001"), new Guid("10000000-0000-0000-0000-000000000001"), new Guid("30000000-0000-0000-0000-000000000001"), new DateTimeOffset(new DateTime(2026, 7, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Prioritize the first sprint with the product owner.", 1024L, "High", new Guid("20000000-0000-0000-0000-000000000001"), "Review product backlog", new DateTimeOffset(new DateTime(2026, 7, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L },
                    { new Guid("40000000-0000-0000-0000-000000000002"), new Guid("10000000-0000-0000-0000-000000000002"), new Guid("30000000-0000-0000-0000-000000000002"), new DateTimeOffset(new DateTime(2026, 7, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Implement authenticated real-time updates.", 1024L, "Critical", new Guid("20000000-0000-0000-0000-000000000001"), "Build collaborative board", new DateTimeOffset(new DateTime(2026, 7, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L },
                    { new Guid("40000000-0000-0000-0000-000000000003"), new Guid("10000000-0000-0000-0000-000000000001"), new Guid("30000000-0000-0000-0000-000000000003"), new DateTimeOffset(new DateTime(2026, 7, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Document ports, adapters and trade-offs.", 1024L, "Medium", new Guid("20000000-0000-0000-0000-000000000001"), "Define architecture", new DateTimeOffset(new DateTime(2026, 7, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L }
                });
        }
